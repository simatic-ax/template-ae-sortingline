This this just a dummy repo for the application example "ae-sortingline". It works as a placeholder so that the package with the application can be hosted.
